...
export default function Navbar({ auth }) {
    ...
    return (
        <>
            {/* ── Desktop / Mobile bar ───────────────────────────── */}
            <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 md:px-8 py-3 md:py-4 max-w-7xl mx-auto bg-[#131313]/70 backdrop-blur-xl rounded-full mt-3 md:mt-4 shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
