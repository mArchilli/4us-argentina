                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-stretch">
                    ...
                    <div ref={infoRef} className="md:col-span-5 flex flex-col justify-start opacity-0 -translate-x-8 transition-all duration-700 ease-out [&.animate-in]:opacity-100 [&.animate-in]:translate-x-0">
                        ...
                        <div className="space-y-4 mt-6 sm:mt-8">
                            ...
                            <div className="flex flex-col gap-4">
                                <a className="inline-flex items-center gap-3 sm:gap-4 group w-fit" href="https://wa.me/5491169659907" target="_blank" rel="noreferrer">
                                ...
                                <a className="inline-flex items-center gap-4 group w-fit" href="mailto:contacto@4usargentina.com" target="_blank" rel="noreferrer">
                                    ...
                                    <span className="text-sm sm:text-lg font-bold group-hover:text-[#8eff71] transition-colors break-all">contacto@4usargentina.com</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div ref={formRef} className="md:col-span-7 flex flex-col opacity-0 translate-x-8 transition-all duration-700 ease-out delay-150 [&.animate-in]:opacity-100 [&.animate-in]:translate-x-0">
                        <img
                            ...
                            alt="Contact Image"
                            className="w-full mb-6 sm:mb-8 rounded-2xl object-cover max-h-[200px] sm:max-h-[300px]"
                            loading="lazy"
                            decoding="async"
                        />
